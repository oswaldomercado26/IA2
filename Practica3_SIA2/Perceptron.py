...
mainwindow.wm_title('Adaline')
#Creamos los valores de los pesos y humbral de activacion 
w1 = random.random()
w2 = random.random()
theta = random.random()
eta = StringVar(mainwindow, 1)
a = StringVar(mainwindow, 1)
...
red_green_button = Button(mainwindow, text="Good", width=10, command=change_color)
